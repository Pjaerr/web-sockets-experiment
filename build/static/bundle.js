...
/* harmony import */ var _src_components_Paint_Client_Paint_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/components/Paint/Client_Paint.js */ "./src/components/Paint/Client_Paint.js");


function render() {
  Object(_src_components_Paint_Client_Paint_js__WEBPACK_IMPORTED_MODULE_0__["draw"])();
} //Game Loop
...
/***/ "./src/components/Paint/Client_Paint.js":
/*!**********************************************!*\
  !*** ./src/components/Paint/Client_Paint.js ***!
  \**********************************************/
...
/* harmony import */ var _util_canvas_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../util/canvas.js */ "./src/util/canvas.js");
/* harmony import */ var _util_input_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util/input.js */ "./src/util/input.js");
...
_client_js__WEBPACK_IMPORTED_MODULE_2__["socket"].on('connected', function (data) {
  colour = data.colour;
...
var restoreState = function restoreState(state) {
  for (var i = 0; i < state.length; i++) {
    for (var j = 0; j < state[i].positions.length; j++) {
      Object(_util_canvas_js__WEBPACK_IMPORTED_MODULE_0__["fillRect"])(state[i].positions[j], {
        x: 10,
        y: 10
      }, state[i].colour);
    }
...
_client_js__WEBPACK_IMPORTED_MODULE_2__["socket"].on('otherPlayerIsDrawing', function (data) {
  Object(_util_canvas_js__WEBPACK_IMPORTED_MODULE_0__["fillRect"])(data.mousePos, {
    x: 10,
    y: 10
  }, data.colour);
});
...
var draw = function draw() {
  if (_util_input_js__WEBPACK_IMPORTED_MODULE_1__["mouseIsClicked"]) {
    Object(_util_canvas_js__WEBPACK_IMPORTED_MODULE_0__["fillRect"])(_util_input_js__WEBPACK_IMPORTED_MODULE_1__["mousePos"], {
      x: 10,
      y: 10
    }, colour);
    _client_js__WEBPACK_IMPORTED_MODULE_2__["socket"].emit('clientIsDrawing', {
      mousePos: _util_input_js__WEBPACK_IMPORTED_MODULE_1__["mousePos"],
      colour: colour
    });
  }
};
...
/*!****************************!*\
  !*** ./src/util/canvas.js ***!
  \****************************/
/*! exports provided: CANVAS, CTX, fillRect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var fillRect = function fillRect(position, size, colour) {
...
/*!***************************!*\
  !*** ./src/util/input.js ***!
  \***************************/
/*! exports provided: mousePos, mouseIsClicked */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mousePos", function() { return mousePos; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mouseIsClicked", function() { return mouseIsClicked; });
/* harmony import */ var _canvas_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas.js */ "./src/util/canvas.js");
...
document.addEventListener('mousemove', function (evt) {
  var rect = _canvas_js__WEBPACK_IMPORTED_MODULE_0__["CANVAS"].getBoundingClientRect();
  mousePos = {
    x: (evt.clientX - rect.left) / (rect.right - rect.left) * _canvas_js__WEBPACK_IMPORTED_MODULE_0__["CANVAS"].width,
    y: (evt.clientY - rect.top) / (rect.bottom - rect.top) * _canvas_js__WEBPACK_IMPORTED_MODULE_0__["CANVAS"].height
  };
});
